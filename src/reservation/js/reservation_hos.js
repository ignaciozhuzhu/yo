...
var Reservation_hosSearch = React.createClass({
  ...
  render: function() {
    $(".serch-bg").bind("touchmove", function(event) {
      event.preventDefault();
    });
    return (
      <div className="serch-bg">
          <div className="weui_search_bar res_hos_padding clance_border" ref="search_bar">
            ...
            <div className="width20 pointer" onClick={this.chooseCity}>
              <div className="lmargin05 wrap-class text-right">
                <span id="displayName" className="search_ads_name">{countyName}</span>
                <img src="images/down_caret copy@2x.png" className="search_ads_img" />
              </div>
            </div>
          </div>

          <div className="res_adsList" id="adsList"></div>
        </div>
    );
  }
