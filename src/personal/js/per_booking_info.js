  ...
  render: function() {
    return (
		<div>
				...
				<div className="weui_panel_bd">
					<div className="weui_media_box weui_media_text bmargin0">
						...
						<div className="weui_media_desc res-det-padleft weui_media_title fontsize15">
							...
							<div className="" >
								<span className="per-npay-info-span color-3 color-f6">主治医生：
									<span id="per-npay-info-doctorname color-black"></span>
								</span>
			...
			<div className="weui_panel weui_panel_access res-det-borbot no-border">
				<div className="weui_panel_bd">
			...
			<div className="per-npay-buttom bmargin1 displaynone">
