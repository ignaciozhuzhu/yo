		...
		return (
			<div>
				...
				<div className="datedet_btn_box">
					<div className="weui_btn weui_btn_primary success_btn" onClick={this.saveClick}>修改</div>
					<div className="weui_btn weui_btn_warn success_btn" onClick={this.delClick}>删除</div>
				</div>
