...
var Personal_mainBox = React.createClass({
  ...
  goHospital: function() {
    ...
    location.href = "../reservation/reservation_hos.html?latitude=" + latitude + "&longitude=" + longitude;
  },
  goDoctor: function() {
    //查找医生
    delCookie("gobackURL");
  ...
  goConsult: function() {
    ...
    location.href = "../personal/aliim.html";
    // return;
  },
  goConsult2: function() {
    // reminder("该功能下一版本上线，敬请关注");
    location.href = "../personal/aliim2.html";
    // return;
  },
  render: function() {
    return (
      <div className="weui_tab"> 
			<div className="weui_tab_bd">
				...
				<div className="weui_grids no-border tmargin1 pointer" onClick={this.goConsult2}>
