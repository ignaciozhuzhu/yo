	            ...
	            success : function(data){
					if( data.status == "success"){
			            if( data.data == 0 ){
			               ...
			               reminder("该号码已在其他端口注册");//当前用户和角色不一致
			               return;
			            }else{
...
var RegisterForm = React.createClass({
  ...
  subOnClick:function(e){
    ...
    $.ajax({	  
		...
		success : function(data){
			if( data.status == "success"){ 
					location.href = "newpassword.html?mobile="+account;
			...
			<div className="weui_cells weui_cells_form reg-margin">
			 ...
			 <article className="weui_article">
			  	<section className="pull-left">
			        <div className="title tit-agree"><img src="images/select.@2x.png" className="img-responsive" width="80%" /></div>
			    </section>
			    <section className="">
			        <div className="title tit-agree fontsize16">&nbsp;&nbsp;我同意<a href="agreement.html">《牙艺用户服务协议》</a></div>
			    </section>
			 </article>
